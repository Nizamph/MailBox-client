...
const InboxDetails = () => {
  ...
  return (
    <React.Fragment>
      <Sidebar/>
     <Container className='col-6 border border-grey mt-4' style={{marginTop:"20rem"}}>
    <div style={{margin:"auto",display:"flex",flexDirection:"column",alignItems:"center"}}>
      <div >
      <h3 style={{borderBottom:"solid thin grey"}}>From:{selectedEmail.authorEmail}</h3>
      </div>
      <div>
       <h3 style={{borderBottom:"solid thin grey"}}>Subject:{selectedEmail.subject}</h3>
      </div>
      <div>
