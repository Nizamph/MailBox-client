...
function SignUp() {
  ...
  return (
    ...
    <Form className={styles.background} onSubmit={formSubmitHandler}>
         <h2 style={{textAlign:'center',marginBottom:"2rem",color:"white"}}>Sign Up</h2>
      <Form.Group className="mb-3" controlId="formBasicEmail">
        <Form.Label className={styles.formLabel}>Email address</Form.Label>
        <Form.Control className={styles.formControl} type="email" placeholder="Enter email" ref={emailInputRef} />
      </Form.Group>
      <Form.Group className="mb-3" >
        <Form.Label className={styles.formLabel}>Password</Form.Label>
        <Form.Control className={styles.formControl} type="password" placeholder="Password" ref={passInputRef} />
      </Form.Group>
      <Form.Group className="mb-3" >
